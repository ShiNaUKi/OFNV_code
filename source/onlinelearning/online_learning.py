...
def draw_cap_error_picture(Z_imp_CER1, Z_imp_CER2, Z_imp_CER3,X_Zero_CER,svm_error):
    n=len(Z_imp_CER1)
    ...
    plt.plot(x, Z_imp_CER1  , color='green')    # the error of z_imp
    plt.plot(x, Z_imp_CER2  , color='yellow')    # the error of z_imp
    plt.plot(x, Z_imp_CER3  , color='black')    # the error of z_imp
