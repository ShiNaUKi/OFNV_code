...
# 'npha':'05_npha.csv',
# 'aad':'06_aad.csv',
# 'creditg':'07_creditg.csv',
# 'qsar_bio':'08_qsar_bio.csv',
# 'cmc':'09_cmc.csv',
# 'obesity':'10_obesity.csv',
# 'abalone':'11_abalone.csv',
# 'mushroom':'12_mushroom.csv',
# 'nursery':'13_nursery.csv',
# 'secondary_mushroom':'14_secondary_mushroom.csv'

def get_cap_hyperparameter(dataset):
    decay_choices = {"ionosphere": 4, "wbc": 2, "wdbc": 0, "german": 3, "diabetes": 2, "credit": 4, "australian": 4,
                     'student_dropout': 4, 'purchase': 4, 'obesity': 4,
                     "abalone": 4, "cmc": 4, "colic": 4, "credita": 4, "creditg": 4, "heart": 4
                     }
    contribute_error_rates = {"ionosphere": 0.02, "wbc": 0.02, "wdbc": 0.02, "german": 0.005, "diabetes": 0.05,
                              "credit": 0.01, "australian": 0.01, 'student_dropout': 0.02, 'purchase': 0.02,
                              'obesity': 0.02,
                              "heart": 0.02,
                              "colic": 2, "ckd": 2, "credita": 2, "asa": 2, "npha": 2, "creditg": 2,
                              "qsar_bio": 2, "cmc": 3, "obesity": 4, "abalone": 8, "mushroom": 16, "nursery": 25,
                              'secondary_mushroom': 120
                              }
    batch_size_denominators = {"ionosphere": 2, "wbc": 2, "wdbc": 2, "german": 2, "diabetes": 2, "australian": 2,
                                "credit": 2, 'student_dropout': 2, 'purchase': 2, 'obesity': 2,
                                "heart": 2, "colic": 2, "ckd": 2, "credita": 2, "aad": 2, "npha": 2, "creditg": 2,
                                "qsar_bio": 2,



                               "cmc": 6, "obesity": 8, "abalone": 16, "mushroom": 32, "nursery": 50,
                               'secondary_mushroom': 240,
                                ...
                                "adult": 100,
                                "bank-marketing": 100}
    window_size_denominators = {"ionosphere": 20, "wbc": 8, "wdbc": 8, "german": 8, "diabetes": 8, "credit": 8,
                               "australian": 10, 'student_dropout': 8, 'purchase': 8, 'obesity': 8,
                               "heart": 2, "colic": 2, "ckd": 2, "credita": 2, "aad": 2, "npha": 2, "creditg": 2,
                               "qsar_bio": 2,

                                "cmc": 3, "obesity": 4, "abalone": 8, "mushroom": 16, "nursery": 25,
                                'secondary_mushroom': 120,
    ...
    shuffles = {"ionosphere": False, "wbc": 2, "wdbc": True, "german": False, "diabetes": True, "australian": False,
                "credit": True, 'student_dropout': False, 'purchase': False, 'obesity': False,
                "abalone": False, "cmc": False, "colic": False, "credita": False, "creditg": False, "heart": False}
    batch_size_denominator = batch_size_denominators[dataset]
    decay_coef_change = 0
    contribute_error_rate = contribute_error_rates.get(dataset, 0.02)
    window_size_denominator = window_size_denominators[dataset]
    shuffle = shuffles.get(dataset, False)
    decay_choice = decay_choices.get(dataset, 4)
    return contribute_error_rate, window_size_denominator, batch_size_denominator, decay_coef_change,decay_choice,shuffle